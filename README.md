...
Or install it as a Claude Code skill: copy [skills/agent-mapreduce/](skills/agent-mapreduce/) into `~/.claude/skills/`, then say `/agent-mapreduce` in any repo. The skill fetches `amr.py` and `program.md` from this repo, fills the params, and starts the loop.
